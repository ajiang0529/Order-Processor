...
public class DataFilesGenerator {
	...
	*/
	...
	private static String BASE_FILE_NAME = "maxItemFile";
	private static int NUMBER_OF_ORDERS = 20;
	private static int DELTA_FOR_ITEMS_PER_ORDER = 10000000;
	
	private static int MIN_ITEMS_PER_ORDER = 10000000;
	private static long RANDOM_SEED_BASE = 1L;
	private static String ITEMS_DATABASE_NAME = "ItemsData.txt";
	/* END Values to change to create new data sets */
	
	private static int MAX_NUMBER_OF_ORDERS = 10000000;
